...
export default function Home() {
  ...
  return (
    <section className='w-full flex flex-col bg-background2 justify-center items-center min-h-dvh px-2 py-20'>
      <section className='w-full max-w-2xl sm:h-[700px] sm:min-h-0 min-h-[700px] h-auto rounded-2xl overflow-hidden bg-background'>
        <section className='w-full h-full flex flex-col justify-start items-start sm:px-8 px-2 py-12 gap-8 overflow-y-scroll custom-scrollbar'>
          <section className='w-full flex justify-center items-center'>
            <h1 className='font-nunito sm:text-3xl text-2xl font-extrabold tracking-wide text-center'>
              Powiadomienia
            </h1>
          </section>
          {isLoading || isError || !notifications ? (
            ...
            <section className='w-full h-auto flex flex-col justify-start pb-4 items-start gap-2'>
